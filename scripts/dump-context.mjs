...
const EXCLUDED_DIRECTORIES = new Set(['.bytefold_meta', '.git', 'node_modules']);
...
export async function generateRepoIndexMarkdown(rootDir = ROOT_DIR) {
  ...
  const lines = [
    ...
    'Scope includes working-tree files and excludes internal/private directories plus `docs/REPO_INDEX.md` (self-reference) and `docs/REPO_INDEX.md.sha256` (self-hash).',
    '',
    '## Git Identity',
    '',
